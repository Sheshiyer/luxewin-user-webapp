...
export function Hero() {
  return (
    <div className="relative overflow-hidden">
      ...
      {/* Content */}
      <div className="relative container mx-auto px-3 sm:px-4 py-8 sm:py-24 md:py-32">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-2xl xs:text-3xl sm:text-5xl md:text-6xl font-bold mb-3 sm:mb-6 bg-clip-text text-transparent bg-gradient-to-r from-[var(--primary-color)] to-[var(--secondary-color)] leading-tight">
            Win Exclusive Prizes in Premium Raffles
          </h1>
          <p className="text-base xs:text-lg sm:text-xl md:text-2xl text-gray-600 dark:text-gray-300 mb-4 sm:mb-8 px-2">
          ...
          <div className="flex flex-col xs:flex-row items-center justify-center gap-2 xs:gap-3 sm:gap-4">
            <Link
              href="/raffles"
              className="w-full xs:w-auto button-primary px-4 xs:px-6 sm:px-8 py-2 xs:py-2.5 sm:py-3 text-xs xs:text-sm sm:text-base"
            >
              Browse Raffles
            </Link>
            <Link
              href="/how-it-works"
              className="w-full xs:w-auto button-outline px-4 xs:px-6 sm:px-8 py-2 xs:py-2.5 sm:py-3 text-xs xs:text-sm sm:text-base"
            >
              How It Works
            </Link>
          </div>
          ...
          {/* Stats */}
          <div className="grid grid-cols-2 md:grid-cols-4 gap-2 xs:gap-3 sm:gap-4 md:gap-8 mt-8 sm:mt-16 bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm rounded-lg sm:rounded-2xl p-3 xs:p-4 sm:p-6 md:p-8 shadow-lg border border-gray-200/50 dark:border-gray-700/50">
            <div className="p-1.5 xs:p-2 sm:p-3">
              <div className="text-xl xs:text-2xl sm:text-3xl font-bold text-[var(--primary-color)]">
                10K+
              </div>
